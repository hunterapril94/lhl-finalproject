...
function UserDetail() {
  ...
  const [showHideCurrentBorrowed, setShowHideCurrentBorrowed] = useState('none')
  let Balance = 0
  useEffect(() => {
    ...
    const promise5 = axios.get(`http://localhost:8001/api/users/my-borrowed-products`)
    ...
    <Grid color={theme.palette.primary.main}>
        ...
        <Grid backgroundColor="white" color={theme.palette.primary.main} xs={3}>
          ...
          <Grid color={theme.palette.primary.main} backgroundColor={theme.palette.secondary.main} xs={9} display='flex' direction='column'>
            ...
            <h2><Button 
            variant='contained' 
            sx={{borderRadius: '50%', marginLeft: '10px', marginRight: '20px'}} 
            type='submit'>
              {lent.length}
              </Button></h2>
            ...
            <Button 
            variant='contained' 
            sx={{borderRadius: '50%', marginLeft: '10px', marginRight: '40px'}} 
            type='submit'>
              {borrowed.length}
              </Button></h2>
          ...
          <Table sx={{ minWidth: 550, display: {showHideBorrowed} }} aria-label="simple table" id='borrow'>
            ...
            <Typography color={theme.palette.primary.main} fontSize='20pt' marginTop='20px' marginLeft='10px'>Currently Lent </Typography><h2><Button variant='contained' sx={{borderRadius: '50%', marginLeft: '10px', marginRight: '20px'}} type='submit'>{currentLent.length}</Button></h2></Box>
            ...
            <Box component='form'
            onSubmit={handleClickCurrentBorrowed}>
          ...
          <Table sx={{ minWidth: 550, display: {showHideCurrentBorrowed} }} aria-label="simple table" id='borrow'>
            <TableHead>
              <TableRow>
                <TableCell>Item</TableCell>
                <TableCell align="center">Contact</TableCell>
            ...
            <Typography color={theme.palette.primary.main} fontSize='20pt' marginTop='20px' marginLeft='10px'>Balance: ${Balance}</Typography>
          </Grid>
